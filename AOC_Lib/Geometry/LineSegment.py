...
class Segment2_DiscreteAA:
    ...
    def _get_intersection_vertical(self, other: 'Segment2_DiscreteAA') -> Optional['Segment2_DiscreteAA']:
    ...
    def _get_intersection_horizontal(self, other: 'Segment2_DiscreteAA') -> Optional['Segment2_DiscreteAA']:
    ...
    def get_intersection(self, other: 'Segment2_DiscreteAA') -> Optional[DiscretePoint2]:
        ...
        return DiscretePoint2(vertical_segment.start_pos.x, horizontal_segment.start_pos.y)

    def is_point_on_segment(self, point: DiscretePoint2) -> bool:
        """Return `True` iff point is on segment"""
        if self.is_vertical:
            return (
                point.x == self.start_pos.x and
                point.y >= self.min_y and
                point.y <= self.max_y
            )
        else:
            return (
                point.y == self.start_pos.y and 
