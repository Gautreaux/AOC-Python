...
def validateVisitList(visitList, checkRehash=True):
    ...
    try:
        ...
        # track the number of hashes that are assigned to multiple values
        hashCollisionErrors = 0
        # track hte number of items that hash into two distinct values
        hashDuplicationErrors = 0
            ...
            if checkRehash and __reHash(element[0], element[1]) != element[2]:
                ...
                if rehashError < 10:
                    print(
                        ...
                        + str(element[2])
                        + ". Rehash value: "
                        + str(__reHash(element[0], element[1]))
                    )
                    if rehashError == 9:
            ...
            if element[2] not in hashMap:
                ...
                if thisPair == elementPair:
                    ...
                    if hashCollisionErrors < 10:
                        print(
                            "Hash collision occurred on hash value "
                            + str(element[2])
                            + ". FirstHash: "
                            + str(thisPair)
                            + ". ThisHash: "
                        ...
                        if hashCollisionErrors == 9:
                            print(
                                "\t>=10 hash collision errors occurred, no more will be printed."
                            )
            ...
            if xValue not in yDict[yValue]:
                ...
                if thisHash == element[2]:
                    ...
                    if hashDuplicationErrors < 10:
                        print(
                            "Hash duplication error occurred on point "
                            + str(elementPair)
                            + ". Original Value: "
                            + thisHash
                            + ". This Value: "
                        ...
                        if hashDuplicationErrors == 9:
                            print(
                                "\t>=10 hash duplication errors occurred, no more will be printed."
                            )
