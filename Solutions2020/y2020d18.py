...
def y2020d18(inputPath = None):
    ...
    Part_1_Answer = sum(map(lambda x: evaluateExpression(initialFormatter(x)), lineList))
    Part_2_Answer = sum(map(lambda x: part2EvaluteExpression(initialFormatter(x)), lineList))
