...
def candidateGenerator(start:str, charset:str=_CHARSET) -> Generator[tuple, None, None]:
...
def y2015d11(inputPath = None):
    ...
    password_generator = filter(filterFunction, candidateGenerator(lineList[0], charset=my_charset))
